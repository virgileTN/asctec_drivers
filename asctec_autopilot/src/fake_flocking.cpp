...
if (sup) {
  ...
  current.latitude = 486586090;
  current.longitude = 61371060;
  cout <<  "current long: " << current.longitude << ", current lat: " << current.latitude << "\n";
  ...
  while (!stop)
  {
	...
	double X4 = (X + X2 + X3) / 3;
	double Y4 = (Y + Y2 + Y3) / 3;
	//double X4 = (std::min(X,std::min(X2,X3))+std::max(X,std::max(X2,X3))) / 2;
	//double Y4 = (std::min(Y,std::min(Y2,Y3))+std::max(Y,std::max(Y2,Y3))) / 2;
    ...
    msg2.X=lon*10000000;
    msg2.Y=lat*10000000;
    cout << "arriere gauche long: " << lon*10000000 << ", lat: " << lat*10000000 << "\n";
    msg2.height=height+diff_hauteur+offset2;
    ...
    msg3.X=lon*10000000;
    msg3.Y=lat*10000000;
    cout << "arriere droit long: " << lon*10000000 << ", lat: " << lat*10000000 << "\n";
    msg3.height=height-diff_hauteur+offset3;
	...
	msg4.X = lon * 10000000;
	msg4.Y = lat * 10000000;
    cout << "superv long: " << lon*10000000 << ", lat: " << lat*10000000 << "\n";
    ...
    cout << "miparc leader long: " << lon*10000000 << ", lat: " << lat*10000000 << "\n";
    msg.chksum = (short) 0xAAAA + msg.yaw + msg.height + msg.time + msg.X + msg.Y + msg.max_speed + msg.pos_acc + msg.properties + msg.wp_number;
    ...
    msg2.X=lon*10000000;
    msg2.Y=lat*10000000;
    cout << "miparc arriere gauche long: " << lon*10000000 << ", lat: " << lat*10000000 << "\n";
    msg2.chksum = (short) 0xAAAA + msg2.yaw + msg2.height + msg2.time + msg2.X + msg2.Y + msg2.max_speed + msg2.pos_acc + msg2.properties + msg2.wp_number;
    ...
    msg3.X=lon*10000000;
    msg3.Y=lat*10000000;
    cout << "miparc arriere droit long: " << lon*10000000 << ", lat: " << lat*10000000 << "\n";
    msg3.chksum = (short) 0xAAAA + msg3.yaw + msg3.height + msg3.time + msg3.X + msg3.Y + msg3.max_speed + msg3.pos_acc + msg3.properties + msg3.wp_number;
	...
	msg4.X = lon * 10000000;
	msg4.Y = lat * 10000000;
       cout << "miparc superv long: " << lon*10000000 << ", lat: " << lat*10000000 << "\n";
	msg4.chksum = (short)0xAAAA + msg4.yaw + msg4.height + msg4.time + msg4.X + msg4.Y + msg4.max_speed + msg4.pos_acc + msg4.properties + msg4.wp_number;
  ...
  //  if(!wait_for_wp()) return 0;
    ...
    msg.Y=latitude_dest;
    cout << "dest leader long: " << lon*10000000 << ", lat: " << lat*10000000 << "\n";
    msg.chksum = (short) 0xAAAA + msg.yaw + msg.height + msg.time + msg.X + msg.Y + msg.max_speed + msg.pos_acc + msg.properties + msg.wp_number;
    ...
    msg2.X=lon*10000000;
    msg2.Y=lat*10000000;
    cout << "dest arriere gauche long: " << lon*10000000 << ", lat: " << lat*10000000 << "\n";
    msg2.chksum = (short) 0xAAAA + msg2.yaw + msg2.height + msg2.time + msg2.X + msg2.Y + msg2.max_speed + msg2.pos_acc + msg2.properties + msg2.wp_number;
    ...
    msg3.X=lon*10000000;
    msg3.Y=lat*10000000;
    cout << "dest arriere droit long: " << lon*10000000 << ", lat: " << lat*10000000 << "\n";
    msg3.chksum = (short) 0xAAAA + msg3.yaw + msg3.height + msg3.time + msg3.X + msg3.Y + msg3.max_speed + msg3.pos_acc + msg3.properties + msg3.wp_number;
	...
	msg4.X = lon * 10000000;
	msg4.Y = lat * 10000000;
    cout << "dest superv long: " << lon*10000000 << ", lat: " << lat*10000000 << "\n";
	msg4.chksum = (short)0xAAAA + msg4.yaw + msg4.height + msg4.time + msg4.X + msg4.Y + msg4.max_speed + msg4.pos_acc + msg4.properties + msg4.wp_number;
...
subscriber_cw4 = n.subscribe(sub4, 1, Callback_cw4, ros::TransportHints().tcpNoDelay());}
  ...
  while (!stop)
  {
	...
	double Y5 = Y;
	//4th drone - in the middle of the formation, but higher
	//double X4 = (std::min(X,std::min(X2,std::min(X3,X5)))+std::max(X,std::max(X2,std::max(X3,X5)))) / 2;
	//double Y4 = (std::min(Y,std::min(Y2,std::min(Y3,Y5)))+std::max(Y,std::max(Y2,std::max(Y3,Y5)))) / 2;
	double X4 = (X + X2 + X3 + X5) / 4;
	double Y4 = (Y + Y2 + Y3 + Y5) / 4;
    ...
    msg5.X=lon*10000000;
    msg5.Y=lat*10000000;
    cout << "arriere long: " << lon*10000000 << ", lat: " << lat*10000000 << "\n"; 
	...
	msg4.X = lon * 10000000;
	msg4.Y = lat * 10000000;
	cout << "superviseur long: " << lon*10000000 << ", lat: " << lat*10000000 << "\n"; 
	//4th drone height -- same altitude difference, but on top
  ...
  //  if(!wait_for_wp()) return 0;
	...
	msg5.X = lon * 10000000;
	msg5.Y = lat * 10000000;
        cout << "miparc arriere long: " << lon*10000000 << ", lat: " << lat*10000000 << "\n";
	msg5.chksum = (short)0xAAAA + msg5.yaw + msg5.height + msg5.time + msg5.X + msg5.Y + msg5.max_speed + msg5.pos_acc + msg5.properties + msg5.wp_number;
  ...
  //  if(!wait_for_wp()) return 0;
    ...
    msg2.X=lon*10000000;
    msg2.Y=lat*10000000;
    cout << "fin arriere gauche long: " << lon*10000000 << ", lat: " << lat*10000000 << "\n";
    msg2.chksum = (short) 0xAAAA + msg2.yaw + msg2.height + msg2.time + msg2.X + msg2.Y + msg2.max_speed + msg2.pos_acc + msg2.properties + msg2.wp_number;
    ...
    msg3.X=lon*10000000;
    msg3.Y=lat*10000000;
    cout << "fin arriere droite long: " << lon*10000000 << ", lat: " << lat*10000000 << "\n";
    msg3.chksum = (short) 0xAAAA + msg3.yaw + msg3.height + msg3.time + msg3.X + msg3.Y + msg3.max_speed + msg3.pos_acc + msg3.properties + msg3.wp_number;
	...
	msg4.X = lon * 10000000;
	msg4.Y = lat * 10000000;
        cout << "fin superv long: " << lon*10000000 << ", lat: " << lat*10000000 << "\n";
	msg4.chksum = (short)0xAAAA + msg4.yaw + msg4.height + msg4.time + msg4.X + msg4.Y + msg4.max_speed + msg4.pos_acc + msg4.properties + msg4.wp_number;
	...
	msg5.X = lon * 10000000;
	msg5.Y = lat * 10000000;
        cout << "fin arriere long: " << lon*10000000 << ", lat: " << lat*10000000 << "\n";
	msg5.chksum = (short)0xAAAA + msg5.yaw + msg5.height + msg5.time + msg5.X + msg5.Y + msg5.max_speed + msg5.pos_acc + msg5.properties + msg5.wp_number;
